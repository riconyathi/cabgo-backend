        ...
        <div class="row">
            <div class="col-md-12 m-auto text-justify">
                @if($data)
                  {!! $data->privacy !!}   
                @endif
                <!--<h4>The Scope of This Policy</h4>
                ...
                <ul>
                    ...
                    <li>
                        Information to operationalize loyalty and promotional programs or applications, services, or features you choose to connect or link to your tyt account, such as information about your use of such programs, applications, services, or features; and
                    </li>
                    <li>
                        Information about you provided by specific services, such as demographic and market segment information.
                    </li>
                </ul>
                <b>Enterprise Programs.</b> If you use tyt through your employer or other organization that participates in one of our tyt Business enterprise programs, we will collect information about you from those parties, such as your name and contact information.
                <br><br><b>Concierge Service.</b> Sometimes another business or entity may order you a tyt ride. If an organization has ordered a ride for you using our Concierge service, they will provide us your contact information and the pickup and drop-off location of your ride.
                <br><br><b>Referral Programs.</b> Friends help friends use the tyt Platform. If someone refers you to tyt, we will collect information about you from that referral including your name and contact information.
                <br><br><b>Other Users and Sources.</b> Other users or public or third-party sources such as law enforcement, insurers, media, or pedestrians may provide us information about you, for example as part of an investigation into an incident or to provide you support.
                ...
                <b>Providing the tyt Platform.</b> We use your personal information to provide an intuitive, useful, efficient, and worthwhile experience on our platform. To do this, we use your personal information to:
                <ul>
                ...
                <b>Maintaining the Security and Safety of the tyt Platform and its Users.</b> Providing you a secure and safe experience drives our platform, both on the road and on our apps. To do this, we use your personal information to:
                <ul>
                ...
                <b>Building and Maintaining the tyt Community.</b> tyt works to be a positive part of the community. We use your personal information to:
                <ul>
                ...
                <b>Providing Customer Support.</b> We work hard to provide the best experience possible, including supporting you when you need it. To do this, we use your personal information to:
                <ul>
                ...
                <b>Improving the tyt Platform</b>. We are always working to improve your experience and provide you with new and helpful features. To do this, we use your personal information to:
                <ul>
                ...
                <b>Responding to Legal Proceedings and Requirements.</b> Sometimes the law, government entities, or other regulatory bodies impose demands and obligations on us with respect to the services we seek to provide. In such a circumstance, we may use your personal information to respond to those demands or obligations.
                <br><br>
                <h4>How We Share Your Information</h4>
                We do not sell your personal information. To make the tyt Platform work, we may need to share your personal information with other users, third parties, and service providers. This section explains when and why we share your information.

                <br><br>
                <h5>A. Sharing Between tyt Users</h5>
                Riders and Drivers.
                <br><br><b>Rider information shared with Driver:</b> Upon receiving a ride request, we share with the Driver the Rider’s pickup location, name, profile photo, rating, Rider statistics (like approximate number of rides and years as a Rider), and information the Rider includes in their Rider profile (like preferred pronouns). Upon pickup and during the ride, we share with the Driver the Rider’s destination and any additional stops the Rider inputs into the tyt app. Once the ride is finished, we also eventually share the Rider’s rating and feedback with the Driver. (We remove the Rider’s identity associated with ratings and feedback when we share it with Drivers, but a Driver may be able to identify the Rider that provided the rating or feedback.)
                <br><br><b>Driver information shared with Rider:</b> Upon a Driver accepting a requested ride, we will share with the Rider the Driver’s name, profile photo, preferred pronouns, rating, real-time location, and the vehicle make, model, color, and license plate, as well as other information in the Driver’s tyt profile, such as information Drivers choose to add (like country flag and why you drive) and Driver statistics (like approximate number of rides and years as a Driver).
                <br><br>Although we help Riders and Drivers communicate with one another to arrange a pickup, we do not share your actual phone number or other contact information with other users. If you report a lost or found item to us, we will seek to connect you with the relevant Rider or Driver, including sharing actual contact information with your consent.
                <br><br><b>Shared Ride Riders.</b> When Riders use a tyt Shared ride, we share each Rider’s name and profile picture to ensure safety. Riders may also see each other’s pickup and drop-off locations as part of knowing the route while sharing the ride.
                <br><br><b>Rides Requested or Paid For by Others.</b> Some rides you take may be requested or paid for by others. If you take one of those rides using your tyt Business Profile account, a code or coupon, a subsidized program (e.g., transit or government), or a corporate credit card linked to another account, or another user otherwise requests or pays for a ride for you, we may share some or all of your ride details with that other party, including the date, time, charge, rating given, region of trip, and pick up and drop off location of your ride.
                <br><br><b>Referral Programs.</b> If you refer someone to the tyt Platform, we will let them know that you generated the referral. If another user referred you, we may share information about your use of the tyt Platform with that user. For example, a referral source may receive a bonus when you join the tyt Platform or complete a certain number of rides and would receive such information.

                <br><br>
                <h5>B. Sharing With Third-Party Service Providers for Business Purposes</h5>
                Depending on whether you’re a Rider or a Driver, tyt may share the following categories of your personal information for a business purpose to provide you with a variety of the tyt Platform’s features and services:
                <ul>
                    <li>Personal identifiers, such as your name, address, email address, phone number, date of birth, government identification number (such as social security number), driver’s license information, vehicle information, and car insurance information;</li>
                ...
                <h5>C. For Legal Reasons and to Protect the tyt Platform</h5>
                <ul>
                ...
                <h5>D. In Connection with Sale or Merger</h5>
                ...
                <br><br>
                <h5>E. Upon Your Further Direction</h5>
                ...
                We retain your information for as long as necessary to provide you and our other users the tyt Platform. This means we keep your profile information for as long as you maintain an account. We retain transactional information such as rides and payments for at least seven years to ensure we can perform legitimate business functions, such as accounting for tax obligations. If you request account deletion, we will delete your information as set forth in the “Deleting Your Account” section below.
                ...
                <br><br>
                <h4>Your Rights And Choices Regarding Your Data</h4>
                tyt provides ways for you to access and delete your personal information as well as exercise other data rights that give you certain control over your personal information.

                <br><br>
                <h5>A. All Users</h5>
                Email Subscriptions. You can always unsubscribe from our commercial or promotional emails by clicking unsubscribe in those messages. We will still send you transactional and relational emails about your use of the tyt Platform.
                <br><br><b>Text Messages.</b> You can opt out of receiving commercial or promotional text. You may also opt out of receiving all texts from tyt (including transactional or relational messages. Note that opting out of receiving all texts may impact your use of the tyt Platform. Drivers can also opt out of driver-specific messages by texting STOP in response to a driver SMS. To re-enable texts you can text START in response to an unsubscribe confirmation SMS.
                <br><br><b>Push Notifications.</b> You can opt out of receiving push notifications through your device settings. Please note that opting out of receiving push notifications may impact your use of the tyt Platform (such as receiving a notification that your ride has arrived).
                <br><br><b>Profile Information</b>. You can review and edit certain account information you have chosen to add to your profile by logging in to your account settings and profile.
                <br><br><b>Location Information.</b> You can prevent your device from sharing location information through your device’s system settings. But if you do, this may impact tyt’s ability to provide you our full range of features and services.
                <br><br><b>Cookie Tracking.</b> You can modify your cookie settings on your browser, but if you delete or choose not to accept our cookies, you may be missing out on certain features of the tyt Platform.
                <br><br><b>Do Not Track.</b> Your browser may offer you a “Do Not Track” option, which allows you to signal to operators of websites and web applications and services that you do not want them to track your online activities. The tyt Platform does not currently support Do Not Track requests at this time.
                <br><br><b>Deleting Your Account.</b> If you would like to delete your tyt account, please visit our privacy homepage. In some cases, we will be unable to delete your account, such as if there is an issue with your account related to trust, safety, or fraud. When we delete your account, we may retain certain information for legitimate business purposes or to comply with legal or regulatory obligations. For example, we may retain your information to resolve open insurance claims, or we may be obligated to retain your information as part of an open legal claim. When we retain such data, we do so in ways designed to prevent its use for other purposes.
                <br><br><b>Right to Know.</b> You have the right to know and see what data we have collected about, including:
                <ul>
                ...
                <b>Right to Delete.</b> You have the right to request that we delete the personal information we have collected from you (and direct our service providers to do the same). There are a number of exceptions, however, that include, but are not limited to, when the information is necessary for us or a third party to do any of the following:
                <ul>
                ...
                <br><br><b>Website:</b> You may visit our privacy homepage to authenticate and exercise rights via our website.
                <br><br><b>Email webform:</b> You may write to us to exercise rights.
